...
function nameGenerator(fileName) {
    ...
    if(fileName.includes('.')) {
        ...
        loop1: for(var icon in fileIcons.icons) {
            if(fileIcons.icons[icon]["fileExtensions"]) {
                for(var sub in fileIcons.icons[icon]["fileExtensions"]) {
                    if(fileIcons.icons[icon]["fileExtensions"][sub] == fileName) {
                        return 'https://raw.githubusercontent.com/PKief/vscode-material-icon-theme/main/icons/'+fileIcons.icons[icon]["name"] + '.svg'
                    }
                }
            }
        }
